...
function activate(context) {
  ...
  vscode.commands.registerCommand('screenify.activate', () => {
    ...
    // const brushImg = vscode.Uri.file(path.join(vscode.context.extensionPath, 'webview', 'assets', 'svg-icons', 'brush.svg')).with({
    //   scheme: 'vscode-resource'
    // })
    const onDiskPath = vscode.Uri.file(path.join(vscode.context.extensionPath, '/webview/assets/svg-icons/brush.svg'))
