    ...
    function activate(context) {
      ...
      class TreeDataProvider {
        constructor() {
          this.data = [new TreeItem("Give me your feedback!"), new TreeItem("More Info")];
        }
        getTreeItem(element) {
          return element;
        }
      ...
      class TreeItem extends vscode.TreeItem {
        ...
        // iconPath = {
        //   light: path.join(context.extensionPath, 'resources', 'continue.png'),
        //   dark: path.join(context.extensionPath, 'resources', 'continue.png')
        // };
      }
