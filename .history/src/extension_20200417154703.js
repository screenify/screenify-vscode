    ...
    function activate(context) {
      ...
      vscode.commands.registerCommand('screenify.moreInfo', () => {
        vscode.commands.executeCommand('vscode.open', vscode.Uri.parse('https://github.com/AdanMomen/screenify-vscode/issues/'))
      });
      class TreeDataProvider {
        constructor() {
          this.data = [
            new TreeItem("Give me your feedback!", "twitter.svg", ""),
            new TreeItem("More Info", "question.png"),
            new TreeItem("GitHub", "gitgub.png")
          ];
        }
        getTreeItem(element) {
          return element;
      ...
      class TreeItem extends vscode.TreeItem {
        ...
        constructor(label, icon, path, cmd = "screenify.openUri") {
          super(label, vscode.TreeItemCollapsibleState.None);
          this.iconPath = `resources/${icon}`;
          this.command = cmd
          this._path = path
        }
        openUri() {
          openExternal(this._path)
        }
      }
