    ...
    window.onload = function () {
      (function () {
        ...
        snippetContainerNode.clientWidth = snippetNode.clientWidth + 5
        snippetContainerNode.clientHeight = snippetNode.clientWidth + 5


        function reactToContainerResize(width, height) {
          if (continerName === "snippetNode")

            snippetHeight.innerText = Math.floor(new Number(height))
          snippetWidth.innerText = Math.floor(new Number(width))
          snippetContainerNode.clientHeight = width + 5
          snippetContainerNode.clientHeight = height + 5
