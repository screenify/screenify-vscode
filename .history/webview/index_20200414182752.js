...
window.onload = function () {
  (function () {
    ...
    themeColor = new vscode.ThemeColor('badge.background'), //get the background themje
      toolbar = document.getElementsByClassName("toolbar").style.background = themeColor
