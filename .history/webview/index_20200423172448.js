      ...
      (function () {
        ...
        **/
        ...
        function ReactToMouseDown(e) {
          ...
          if (currentTool === 'brush') {
            usingBrush = true;
            AddBrushPoint(loc.x, loc.y, mouseDown = false, brushColor = strokeColor, brushSize = line_Width, mode = "begin", tool = currenTool);
          }
        };
        ...
        function ReactToMouseMove(e) {
          ...
          if (currentTool === 'brush' && dragging && usingBrush) {
            if (loc.x > 0 && loc.x < canvasWidth && loc.y > 0 && loc.y < canvasHeight) {
              ctx.lineTo(loc.x, loc.y);
              ctx.stroke();
              AddBrushPoint(loc.x, loc.y, mouseDown = true, brushColor = strokeColor, brushSize = line_Width, mode = "draw", tool = currenTool);
            }
            redrawCanvasImage();
            DrawBrush();
          } else {
        ...
        function ReactToMouseUp(e) {
          saveCanvasImage()
          if (currentTool === "brush") AddBrushPoint(loc.x, loc.y, mouseDown = false, brushColor = fillColor, brushSize = line_Width, mode = "end", tool = currenTool);
