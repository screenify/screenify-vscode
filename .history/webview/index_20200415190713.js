        ...
        (function () {
            ...
            window.addEventListener("message", e => {
              ...
              `
                ...
                }); window.addEventListener("keypress", ReactToKeyup) window.addEventListener("keyup", ReactToKeyup)
              ...
              // Holds x & y location of the mouse
              let loc = new Location(0, 0); ctx.strokeStyle = strokeColor; ctx.lineWidth = line_Width;
