    ...
    window.onload = function () {
      (function () {
        ...
        /** Snippet on Resize Event Listener  **/
         ...
         * @function html2blob
         * @returns {Promise}
         * an abstract function that is using html2 canvas function to return a promise
         */
        function html2blob() {
        ...
        /**
         * @function snippetHandler Main function that handles canvas capturing and blob serializing and sending blob to vscode api.
