        ...
        **/
        ...
        function ReactToMouseMove(e) {
          ...
          if (currentTool === 'brush' && dragging && usingBrush) {
            ...
            // TODO: Make the drawing stop on exceding canvas bounderies
            redrawCanvasImage();
            DrawBrush();
          } else {
            if (dragging) {
         ...
         * Restores the previous state of canvas.
         **/
        function restoreState() {
          ...
          /** take the previos canavas history **/
          restore_state = undo_array[--currentState]

          /** if Brush tool was used deletes brush points**/
          if (restore_state.currentTool === "brush") {

            /** Deletes Last Brush Point **/
            deleteLastBrushPoint()

            /** Draws the brush after deleting Last Brush Point **/
            DrawBrush()
          }
