    ...
    window.onload = function () {
      (function () {
        ...
        /** Brush Event On Click Event Listener **/
        brush.addEventListener("click", () => {
          changeTool("brush")
        })

        /** Line Event On Click Event Listener **/
        line.addEventListener("click", () => {
          changeTool("line")
        })

        /** Rectangle Event On Click Event Listener **/
        rectangle.addEventListener("click", () => {
          changeTool("rectangle")
        })
        /** Undo Event On Click Event Listener **/
        undo.addEventListener("click", () => {
          undoChanges()
        })
        /** CopyBtn Event On Click Event Listener **/
