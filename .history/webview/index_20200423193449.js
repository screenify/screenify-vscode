    ...
    window.onload = function () {
      (function () {
        ...
        clipBoardBtn.addEventListener("click", () => {
          document.getElementById("copyNtif").style.display = "inline";
        })
        ...
        window.addEventListener("message", e => {
          if (e) {
            if (e.data.type === "init") {
              ...
              const uploadedUrlContainer = document.getElementById("upload-container");
              ...
              uploadedUrlContainer.innerHTML =
               ...
               <div class="card" style="align-items:center" id="innerUrlContainer">
                <div class="card-body">
                 < input style = "align-self:center; width: calc(100% - 10rem);"
                 type = "text"
                value = "${e.data.url}" >
                 <button id="clipboardBtn" class="btn" data-clipboard-target="#foo">
                    ...
                    <spna id="copyNotif" style="display:none">Copied!<span>
                </div>
              </div>   
              `
              /** ClipBoard Button on the uploadedUrlContainer **/
