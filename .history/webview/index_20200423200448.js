          ...
          if (e) {
            if (e.data.type === "init") {
              ...
              uploadedUrlContainer.innerHTML =
                `
               <div class="card"  id="innerUrlContainer">
                <div class="card-body">
                 <input style ="width:100%"
                 type = "text"
                value = "${e.data.url}">
                 <button id="clipboardBtn" class="btn" style="align-items:center" data-clipboard-target="#foo">
              ...
              document.getElementById("clipboardBtn").addEventListener("click", () => {
                document.getElementById("copyNotif").style.display = ""
              })
